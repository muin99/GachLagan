...
public class SystemKeyboard extends InputMethodService implements OnKeyboardEventListener {
  ...
  public void onCreate() {
    super.onCreate();
    KMManager.setDebugMode(BuildConfig.DEBUG);
    ...
    // Register the shared Keyman package bundled by both mobile targets.
    Keyboard kbInfo = new Keyboard(
      "avro_phonetic",  // Package ID - filename of the .kmp file
      "avro_phonetic",  // Keyboard ID
      ...
      // Android's system Bengali font renders both the keys and committed text.
      KMManager.KMDefault_KeyboardFont,
      KMManager.KMDefault_KeyboardFont); // Font for OSK
    KMManager.addKeyboard(this, kbInfo);
    KMManager.setDefaultKeyboard(kbInfo);
  }
